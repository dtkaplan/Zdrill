...
**M3-01**  Which of these basic modeling functions has a discontinuity? [M03]
...
**M3-02** What is the period of the $\sin()$ function? [M03]
...
**M3-03** Which of the basic modeling functions has value very near zero over almost **all** of its domain? [M03]
...
**M3-04** Which of these basic modeling functions has value very near zero over almost **half** of its domain? [M03]
...
**M3-05** Which of these basic modeling functions has value very near zero over almost **half** of its domain? [M03]
...
**M3-06** Which of these words is most appropriate to describe the function $g(x) \equiv 2 - 3 x + 4x^3 ?$ [M03]
...
**M3-07** Which of these pattern-book functions is **not** a monomial? [M03]

[+] $\sqrt{x}$ [M0onomials are functions of the form $x^n$, where $n = 0, 1, 2, \ldots$, that is, an integer.]
[] $x^2$
[] $x$ [It might be easier to see that this is a monomial if we write it as $x^1$]

**M3-08** Which value(s) is **missing from** the domain of $x^{-1}$? [M03]
...
**M3-09** Which value(s) is **missing from** the domain of $x^{1/2}$? [M03]
...
**M3-10** Which value(s) is **missing from** the domain of $\ln(x)$? [M03]
...
**M3-11** Which value(s) is **missing from** the domain of $\sin(x)$? [M03]

[] Zero
[] All non-positive numbers [This is another way of saying, "The number line except for zero and negative numbers."]
[] Negative numbers
[a] No numbers are missing.
**M3-12** Which of these functions is **concave up** over the domain shown in the graph? [M03]
...
**M3-13** Which of these functions has a **vertical** asymptote? [M03]
...
**M3-14** Which of these functions has a **vertical** asymptote? [M03]
...
**M3-15** For this function <br><img src="https://raw.githubusercontent.com/dtkaplan/Zdrill/main/inst/M3/M3-14-06.png"></br> where is the **vertical** asymptote located? [M03]
...
**M3-16a** Does this function have an **inflection point**? <br><img src="https://raw.githubusercontent.com/dtkaplan/Zdrill/main/inst/M3/M3-12-03.png"> [M03]
...
**M3-16b** Does this function have an **inflection point**? <br><img src="https://raw.githubusercontent.com/dtkaplan/Zdrill/main/inst/M3/M3-14-04.png"> [M03]
...
**M3-17** For this function <br><img src="https://raw.githubusercontent.com/dtkaplan/Zdrill/main/inst/M3/M3-14-06.png"></br> where is the **horizontal** asymptote located? [M03]
...
**M3-18** Which of these is a correct description of a horizontal asymptote in the function shown in the graph?<br><img src="https://raw.githubusercontent.com/dtkaplan/Zdrill/main/inst/M3/M3-14-07.png"> [M03]
...
**M3-19** Which of these is a correct description of a horizontal asymptote in the function shown in the graph?<br><img src="https://raw.githubusercontent.com/dtkaplan/Zdrill/main/inst/M3/M3-14-07.png"> [M03]
...
**M3-20** Which value(s) is **missing from** the domain of $x^{-1/2}$? [M03]
...
**M3-notation-1** Using our notation conventions from the textbook, which one of the following kinds of things is $y_0 ?$ [M03]
