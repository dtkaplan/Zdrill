...
**assign4** We can write something like <br>$f(x) \equiv x^2$ </br> in mathematical notation. Is it legit in R to write `f(x) <- x^2` ? [2-B]
...
**arg17** What is the value of `sin(180)`? [3-A]
...
**desc01** What is the value of `16^1/2`?
...
**desc02** What is the value of `16^(1/2)`?
